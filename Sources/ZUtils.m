...
#if DEBUG
NSInteger ZUnexpectedInteger_(NSInteger value, const char *file, int line)
{
	NSLog(@"Unexpected integer %d: %s (%d)", value, file, line);
	[NSException raise:@"Inline Assertion" format:@"Inline assertion failed at %s (%d)", file, line];
	return value;
}
#endif

#if DEBUG
float ZUnexpectedFloat_(float value, const char *file, int line)
{
	NSLog(@"Unexpected float %f: %s (%d)", value, file, line);
	[NSException raise:@"Inline Assertion" format:@"Inline assertion failed at %s (%d)", file, line];
	return value;
}
#endif
...
#if DEBUG
NSString *ZUnexpectedString_(NSString *value, const char *file, int line)
{
	NSLog(@"Unexpected string %@: %s (%d)", value, file, line);
	[NSException raise:@"Inline Assertion" format:@"Inline assertion failed at %s (%d)", file, line];
	return value;
}
#endif
